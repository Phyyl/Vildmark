...
namespace Vildmark.Physics.Dynamics.Contacts;
    ...
    internal void Update(ContactManager contactManager)
    {
        ...
        else
        {
            if (touching == false)
            {
                ...
                bodyA.onSeparationEventHandler?.Invoke(FixtureA, FixtureB, this);

                //Reverse the order of the reported fixtures. The first fixture is always the one that the
                //user subscribed to.
                bodyB.onSeparationEventHandler?.Invoke(FixtureB, FixtureA, this);
