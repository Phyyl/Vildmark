...
using Vildmark.Physics.Collision.Shapes;
using Vildmark.Physics.Common;
using Vildmark.Physics.Common.PhysicsLogic;
...
public partial class Body
{
    ...
    public BodyType BodyType
    {
        ...
        set
        {
            ...
            {
                if (ce.Contact is not null)
                {
                    World.ContactManager.Destroy(ce.Contact);
                }
    ...
    public void Add(Fixture fixture)
    {
        ...
        if (World != null)
        {
            ...
            World.FixtureAdded?.Invoke(World, this, fixture);
        }
    }
    ...
    public virtual void Remove(Fixture fixture)
    {
        ...
        World.FixtureRemoved?.Invoke(World, this, fixture);
    ...
    {
        Transform xf1 = new(Vector2.Zero, _sweep.A0);
