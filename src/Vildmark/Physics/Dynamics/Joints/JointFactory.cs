...
namespace Vildmark.Physics.Dynamics.Joints;
...
public static class JointFactory
{
    ...
    {
        MotorJoint joint = new(bodyA, bodyB, useWorldCoordinates);
        world.Add(joint);
        return joint;
    }
    ...
    {
        RevoluteJoint joint = new(bodyA, bodyB, anchorA, anchorB, useWorldCoordinates);
        world.Add(joint);
        return joint;
    }
    ...
    public static RevoluteJoint CreateRevoluteJoint(World world, Body bodyA, Body bodyB, Vector2 anchor)
    {
        ...
        RevoluteJoint joint = new(bodyA, bodyB, localanchorA, anchor);
        world.Add(joint);
        return joint;
    }
    ...
    {
        PrismaticJoint joint = new(bodyA, bodyB, anchor, axis, useWorldCoordinates);
        world.Add(joint);
        return joint;
    }
    ...
    {
        WheelJoint joint = new(bodyA, bodyB, anchor, axis, useWorldCoordinates);
        world.Add(joint);
        return joint;
    }
    ...
    {
        FixedMouseJoint joint = new(body, worldAnchor);
        world.Add(joint);
        return joint;
    }
}