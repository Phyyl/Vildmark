...
public class PulleyJoint : Joint
{
        ...
        : base(bodyA, bodyB)
    {
        ...
        if (useWorldCoordinates)
        {
            ...
            LengthA = dA.LengthSquared;
            Vector2 dB = anchorB - worldAnchorB;
            LengthB = dB.LengthSquared;
        }
        else
        {
    ...
    internal override void InitVelocityConstraints(ref SolverData data)
    {
        ...
        float lengthA = _uA.LengthSquared;
        float lengthB = _uB.LengthSquared;
    ...
    internal override bool SolvePositionConstraints(ref SolverData data)
    {
        ...
        float lengthA = uA.LengthSquared;
        float lengthB = uB.LengthSquared;
