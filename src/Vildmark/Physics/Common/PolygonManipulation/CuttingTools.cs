...
namespace Vildmark.Physics.Common.PolygonManipulation;
...
public static class CuttingTools
{
    ...
    public static void SplitShape(Fixture fixture, Vector2 entryPoint, Vector2 exitPoint, out Vertices first, out Vertices second)
    {
        ...
        if (fixture.Shape is not PolygonShape shape)
        {
            first = new Vertices();
            second = new Vertices();
            return;
        ...
        Vertices vertices = new(shape.Vertices);
    ...
    public static bool Cut(World world, Vector2 start, Vector2 end)
    {
        ...
        List<Vector2> entryPoints = new();
        List<Vector2> exitPoints = new();
