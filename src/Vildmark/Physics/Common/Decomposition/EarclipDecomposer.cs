        ...
        while (vNum > 3)
        {
            ...
            for (int i = 0; i < vNum; ++i)
            {
                if (IsEar(i, xrem, yrem, vNum))
                {
                    ...
                    Vector2 d1 = new(xrem[upper] - xrem[i], yrem[upper] - yrem[i]);
                    Vector2 d2 = new(xrem[i] - xrem[lower], yrem[i] - yrem[lower]);
                    Vector2 d3 = new(xrem[lower] - xrem[upper], yrem[lower] - yrem[upper]);
