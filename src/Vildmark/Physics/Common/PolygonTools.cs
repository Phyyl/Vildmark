...
public static class PolygonTools
{
                                                  ...
                                                  int segments)
    {
        ...
        else
        {
            ...
            float stepSize = MathF.Tau / (numberOfEdges - 4);
            int perPhase = numberOfEdges / 4;

            Vector2 posOffset = new(width / 2 - xRadius, height / 2 - yRadius);
    ...
    public static Vertices CreateEllipse(float xRadius, float yRadius, int numberOfEdges)
    {
        ...
        float stepSize = MathF.Tau / numberOfEdges;
    ...
    public static Vertices CreateGear(float radius, int numberOfTeeth, float tipPercentage, float toothHeight)
    {
        ...
        float stepSize = MathF.Tau / numberOfTeeth;
        tipPercentage /= 100f;
