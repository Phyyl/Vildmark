...
namespace Vildmark.Graphics.Helpers
{
    public static class CubeHelper
    {
        ...
        {
            foreach (var vertex in GetRightVertices(offset, size, color, texCoord, texSize, texCoordRotation)) yield return vertex;
            foreach (var vertex in GetLeftVertices(offset, size, color, texCoord, texSize, texCoordRotation)) yield return vertex;
            foreach (var vertex in GetTopVertices(offset, size, color, texCoord, texSize, texCoordRotation)) yield return vertex;
            foreach (var vertex in GetBottomVertices(offset, size, color, texCoord, texSize, texCoordRotation)) yield return vertex;
            foreach (var vertex in GetFrontVertices(offset, size, color, texCoord, texSize, texCoordRotation)) yield return vertex;
            foreach (var vertex in GetBackVertices(offset, size, color, texCoord, texSize, texCoordRotation)) yield return vertex;
        }
