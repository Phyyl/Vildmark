...
namespace Vildmark.Maths
{
    ...
    {
        public static Vector2 Round(this Vector2 v, int digits = 0) => new Vector2(MathF.Round(v.X, digits), MathF.Round(v.Y, digits));
        public static Vector3 Round(this Vector3 v, int digits = 0) => new Vector3(MathF.Round(v.X, digits), MathF.Round(v.Y, digits), MathF.Round(v.Z, digits));
        public static Vector4 Round(this Vector4 v, int digits = 0) => new Vector4(MathF.Round(v.X, digits), MathF.Round(v.Y, digits), MathF.Round(v.Z, digits), MathF.Round(v.W, digits));
        ...
        public static Vector2 Ceiling(this Vector2 v) => new Vector2(MathF.Ceiling(v.X), MathF.Ceiling(v.Y));
        public static Vector3 Ceiling(this Vector3 v) => new Vector3(MathF.Ceiling(v.X), MathF.Ceiling(v.Y), MathF.Ceiling(v.Z));
        public static Vector4 Ceiling(this Vector4 v) => new Vector4(MathF.Ceiling(v.X), MathF.Ceiling(v.Y), MathF.Ceiling(v.Z), MathF.Ceiling(v.W));

        public static Vector2 Abs(this Vector2 v) => new Vector2(Math.Abs(v.X), Math.Abs(v.Y));
        public static Vector3 Abs(this Vector3 v) => new Vector3(Math.Abs(v.X), Math.Abs(v.Y), Math.Abs(v.Z));
        public static Vector4 Abs(this Vector4 v) => new Vector4(Math.Abs(v.X), Math.Abs(v.Y), Math.Abs(v.Z), Math.Abs(v.W));

        public static Vector4 ToVector(this Rectangle rectangle) => new Vector4(rectangle.X, rectangle.Y, rectangle.Width, rectangle.Height);
        public static Vector4 ToVector(this RectangleF rectangle) => new Vector4(rectangle.X, rectangle.Y, rectangle.Width, rectangle.Height);

        public static Vector2i ToVector2i(this Vector2 v) => new Vector2i((int)v.X, (int)v.Y);
        public static Vector3i ToVector3i(this Vector3 v) => new Vector3i((int)v.X, (int)v.Y, (int)v.Z);
        public static Vector4i ToVector4i(this Vector4 v) => new Vector4i((int)v.X, (int)v.Y, (int)v.Z, (int)v.W);

        public static RectangleF ToRectangleF(this Vector4 v) => new RectangleF(v.X, v.Y, v.Z, v.W);
