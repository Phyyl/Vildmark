...
namespace Vildmark.Maths
{
    public static class MathsHelper
    {
        ...
        public static Vector2 Min(Vector2 a, Vector2 b) => new(Min(a.X, b.X), Min(a.Y, b.Y));
        public static Vector3 Min(Vector3 a, Vector3 b) => new(Min(a.X, b.X), Min(a.Y, b.Y), Min(a.Z, b.Z));
        public static Vector4 Min(Vector4 a, Vector4 b) => new(Min(a.X, b.X), Min(a.Y, b.Y), Min(a.Z, b.Z), Min(a.W, b.W));

        public static Vector2 Max(Vector2 a, Vector2 b) => new(Max(a.X, b.X), Max(a.Y, b.Y));
        public static Vector3 Max(Vector3 a, Vector3 b) => new(Max(a.X, b.X), Max(a.Y, b.Y), Max(a.Z, b.Z));
        public static Vector4 Max(Vector4 a, Vector4 b) => new(Max(a.X, b.X), Max(a.Y, b.Y), Max(a.Z, b.Z), Max(a.W, b.W));
